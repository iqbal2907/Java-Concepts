 ...
 *
 */
public class SortableStackImpl<E extends Comparable<E>> implements SortableStack<E> {
	...
	public static void main(String []args)throws IOException{
		...
		SortableStack<Integer> s = new SortableStackImpl<Integer>();
